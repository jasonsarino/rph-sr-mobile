...
<div style="width: 75%; margin-left:auto; margin-right:auto; box-shadow: 0 2px 3px 2px rgba(0,0,0,.03) !important; background:#fff; border-radius: 6px;">
      <div style="padding:25px;">
            ...
            <p>You have been added to RCD Pearl Homes Realty Sales Report System. Below is your account credentials to login.</p>
            <p><?=$this->lang->line('login_text_05')?>: <?=$to?></p>
            <p><?=$this->lang->line('login_text_06')?>: <?=$password?></p>
