...
<div class="content">
	...
	<!-- Ajax sourced data -->
	<form enctype="multipart/form-data" action="<?=base_url('approved_sales_report/save_edit')?>" method="post" id="formEditSR">
			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="panel panel-success panel-bordered company_row">
						...
						<div class="panel-body">
							<div class="form-group">
								<label>Enter SR Number</label>
								<input type="text" value="<?=$srDetails->sr_number?>" class="form-control" name="sr_number" placeholder="Enter SR Number">
							</div>
						</div>
					</div>
					<div class="panel panel-success panel-bordered company_row">
