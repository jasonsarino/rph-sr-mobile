<div class="content">
	<form class="form-horizontal" action="<?=base_url('manage_divisions/edit')?>" method="post" id="formEditDivision">
	<input type="hidden" name="id" value="<?=$divisionDetails->id?>">
	...
	<div class="panel panel-success panel-bordered company_row">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					<input type="text" class="form-control" name="division" value="<?=$divisionDetails->division?>" placeholder="Enter Division Name" required>
				</div>
			</div>
	...
	<?php } else {
		echo "<div class='alert alert-warning'><strong>Error!</strong> Invalid division.</div>";
	} ?>
	<!-- /ajax sourced data -->
...
$('#formEditDivision').on('submit', function(e) {
	e.preventDefault();
