	...
	private static function indexAsset()
	{
		$assetsArr = array(
			...
			'js'  		=> 	array(
								...
								base_url('assets/js/plugins/forms/tags/tagsinput.min.js'),
								base_url('assets/js/plugins/forms/tags/tokenfield.min.js'),
								base_url('assets/js/plugins/ui/prism.min.js'),
